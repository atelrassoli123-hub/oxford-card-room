...
export default function Overview() {
  return (
    <section id="overview" data-testid="overview-section" className="relative bg-[#FFFEF9]">
      ...
      <div className="relative w-full h-[55vh] md:h-[72vh] overflow-hidden" data-testid="overview-banner">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#050816]/50 via-transparent to-[#050816]/50" />
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#FFFEF9] pointer-events-none" />
        <div className="absolute bottom-8 right-8 md:bottom-12 md:right-12">
          <p className="font-body text-[8px] uppercase tracking-[0.5em] text-[#C6A76A]/70">:The Card Room</p>
        </div>
      </div>
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-14 py-24 lg:py-36">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <Reveal as="div" className="lg:col-span-4 lg:sticky lg:top-32">
            ...
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-[#1C1814] leading-[1.0] tracking-tight font-bold">
              A card room<br />
          ...
          <Reveal as="div" delay={140} className="lg:col-span-7 lg:col-start-6 space-y-7">
            <p className="font-body text-[#1C1814]/70 text-lg md:text-xl leading-[1.85] tracking-wide">
            ...
            <p className="font-body text-[#1C1814]/55 text-base leading-[1.85]">
            ...
            <p className="font-body text-[#1C1814]/45 text-base leading-[1.85]">
            ...
            <div className="pt-4">
              <div className="w-full h-px bg-[#C6A76A]/20 mb-8" />
              <blockquote data-testid="overview-pullquote">
                <p className="font-display italic text-[#1C1814]/55 text-xl md:text-2xl leading-snug mb-4">
                ...
                <footer className="font-body text-[9px] uppercase tracking-[0.45em] text-[#C6A76A]/70">
      ...
      {/* ── Stats band ───────────────────────────────────── */}
      <div className="relative border-t border-[#C6A76A]/20" data-testid="overview-stats-band">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-14">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-[#C6A76A]/15">
            {STATS.map((s, i) => (
              <Reveal
                key={s.l}
                delay={i * 80}
              ...
              >
                <div
                  className="font-display text-[#C6A76A] font-bold leading-none tracking-tight group-hover:text-[#b8934a] transition-colors"
                  style={{ fontSize: "clamp(56px, 7vw, 96px)" }}
                >
                  <CountUp value={s.v} />
                </div>
                <div className="font-body text-[9px] uppercase tracking-[0.5em] text-[#1C1814]/50 mt-1">
                  :{s.l}
                </div>
                <div className="font-body text-[10px] text-[#1C1814]/35 tracking-wide">
                  {s.sub}
                </div>
              </Reveal>
            ))}
