...
const META = {
  "boxing-night-2027": {
    img: "https://images.unsplash.com/photo-1544117519-31a4b719223d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=900&q=80&w=1200",
    icon: Trophy,
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-14">
        ...
        {events.length > 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#F0EAD6]/[0.04]">
            {[
              { label: "The Knockout Night", sub: "Boxing & Poker · Flagship", badge: "Week IV", detail: "Three sanctioned bouts, a friendly book, and a four-table tournament. The Card Room's most anticipated evening.", img: "https://images.unsplash.com/photo-1544117519-31a4b719223d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=900&q=80&w=1200", badgeColor: "#C6A76A" },
