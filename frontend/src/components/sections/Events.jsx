...
const META = {
  "boxing-night-2027": {
    img: "https://images.unsplash.com/photo-1591117207239-788bf8de6c3b?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=900&q=80&w=1200",
    icon: Trophy,
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-14">
        ...
        {events.length > 0 ? (
              ...
              return (
                <Reveal key={e.id} delay={idx * 80} as="div">
                  <article
                    ...
                    className="relative group flex flex-col bg-[#050816] hover:bg-[#080b16] overflow-hidden transition-all duration-500 h-full"
                  >
                    {/* Image */}
                    ...
                    <div className="flex flex-col flex-1 p-8">
                      ...
                      <p className="font-body text-[#F0EAD6]/35 text-sm leading-relaxed mb-8 flex-1">
                        {e.description}
                      </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#F0EAD6]/[0.04]">
            {[
              { label: "The Knockout Night", sub: "Boxing & Poker · Flagship", badge: "Week IV", detail: "Three sanctioned bouts, a friendly book, and a four-table tournament. The Card Room's most anticipated evening.", img: "https://images.unsplash.com/photo-1591117207239-788bf8de6c3b?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=900&q=80&w=1200", badgeColor: "#C6A76A" },
