...
export default function Manifesto() {
  return (
    <section
      ...
      className="relative py-28 lg:py-44 bg-[#080B18] overflow-hidden"
    >
      {/* Faint glow behind text */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_70%_50%_at_50%_50%,rgba(198,167,106,0.035),transparent)]" />
      ...
      <div className="relative max-w-[1100px] mx-auto px-6 lg:px-12">
        ...
        {/* Label */}
        <Reveal>
          <p className="font-body text-[9px] uppercase tracking-[0.6em] text-[#C6A76A]/60 mb-16 text-center">
            :Philosophy
          </p>
        </Reveal>
        ...
        <Reveal delay={100}>
          <blockquote className="text-center">
            <p
              className="font-display text-[#F0EAD6] leading-[1.05] tracking-tight font-bold"
        ...
        <Reveal delay={450}>
          <div className="mt-20 flex flex-col items-center gap-6 text-center">
            <div className="w-px h-12 bg-[#C6A76A]/25" />
            <p
            ...
            <p className="font-body text-[9px] uppercase tracking-[0.5em] text-[#F0EAD6]/25">
