...
export default function Footer() {
  ...
  return (
    <footer
      ...
      className="relative bg-[#050810] border-t border-[#F5EFDE]/5 pt-16 pb-10"
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-12 gap-10">
        <div className="md:col-span-5">
          <Wordmark size="md" />
          <p className="mt-6 font-body text-[#F5EFDE]/30 text-[13px] leading-relaxed max-w-sm">
        ...
        <FooterCol title="Programme" links={[
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 mt-16 pt-8 border-t border-[#F5EFDE]/5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <p className="font-body text-[10px] uppercase tracking-[0.35em] text-[#F5EFDE]/20">
          © {year} The Oxford Card Room. All rights reserved.
        </p>
        <p className="font-body text-[10px] uppercase tracking-[0.35em] text-[#F5EFDE]/15">
...
function FooterCol({ title, links }) {
  return (
    <div className="md:col-span-2" data-testid={`footer-col-${title.toLowerCase().replace(/\s/g, '-')}`}>
      <p className="font-body text-[9px] uppercase tracking-[0.45em] text-[#C8A662]/50 mb-5">
        :{title}
      </p>
        ...
        {links.map((l) => (
          <li key={l.label}>
            <a
              ...
              className="font-body text-sm text-[#F5EFDE]/30 hover:text-[#C8A662] transition-colors"
            >
              {l.label}
            </a>
          </li>
